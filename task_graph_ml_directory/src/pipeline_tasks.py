"""
Pipeline Task Entry Points for Car Insurance ML DAG (submit_directory version).

In this version, heavy compute tasks (ingest, train, inference) run as ML Jobs
via MLJobDefinition.register() with standalone scripts in the jobs/ directory.
