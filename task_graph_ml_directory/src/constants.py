...
# =============================================================================
# Car Insurance ML Pipeline (submit_directory version) - Configuration Constants
# =============================================================================
# All values can be overridden via environment variables.
# This version uses MLJobDefinition.register() with submit_directory pattern
# to register standalone job scripts as DAG task definitions.
# =============================================================================
...
PIPELINE_SCHEMA = os.getenv("PIPELINE_SCHEMA", "PIPELINE_SUBMIT_FILE")
